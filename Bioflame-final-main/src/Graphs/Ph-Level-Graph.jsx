      ...
      {!loading && (
        <ResponsiveContainer width="100%" height={300}>
          <LineChart data={graphData}>
            ...
            <YAxis stroke="#ccc" domain={[6, 8]} label={{ value: 'pH Level', angle: -90, position: 'insideLeft', fill: '#ccc' }} />
            <Tooltip />
            <Legend />
            <Brush dataKey="name" height={30} stroke="#6C8E3E" fill="#2E3F24" />
            <Line type="monotone" dataKey="value" stroke="#c084fc" strokeWidth={2} activeDot={{ r: 8 }} name="pH Level" />
          </LineChart>
        </ResponsiveContainer>
      )}
    </div>
